...
if _conf_data_mode() == "particle":
    ...
    try:
        prep_config_filepath = script_dir / conf.generic.preparation_config_file
        with open(prep_config_filepath, "r") as f:
            prep_conf_json = json.load(f)
            
        tokenized_metadata_filepath = script_dir / prep_conf_json['tokenized_metadata_file']
