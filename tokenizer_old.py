...
def batch_tokenize_data():
    ...
    if dictionary.particle_count_override is not None:
        assert dictionary.particle_count_override > num_particles_max, "The particle_count_override in the dictionary must be greater than the maximum number of particles found in the dataset."
